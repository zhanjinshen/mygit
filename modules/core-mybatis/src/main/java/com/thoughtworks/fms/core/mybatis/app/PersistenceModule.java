...
public class PersistenceModule extends AbstractModule {
    private Logger LOGGER = Logger.getLogger(PersistenceModule.class);

    private static final String DEFAULT_CONFIG_RESOURCE = "mybatis/mybatis-config.xml";
    ...
    private void bindSqlSessionFactory() {
        try (Reader reader = getResourceAsReader(getResourceClassLoader(), classPathResource)) {
            ...
            LOGGER.error("System Log: Error when bind sqlSession Factory", e);
        }
    }
